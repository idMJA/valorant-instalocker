...
7. Download [imageCFG](https://robpol86.com/imagecfg.html) and place it in the same `InstaLock.exe` folder
8. open CMD in that folder and run `imagecfg -u InstaLock.exe`
